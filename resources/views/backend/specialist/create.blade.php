												...
												<div class="form-wrap">
													<form class="form-horizontal" method="post" action="{{route('specialist.store')}}">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="text" class="form-control" name="specialist" id="exampleInputuname_4" placeholder="Username">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<textarea type="text" class="form-control" name="details" id="exampleInputEmail_4" placeholder="Enter Details" rows="10"></textarea>
